...
未实现的效应（在 §7.3 讨论）：周日光行差、长期光行差、视差、自行。**为满足国标 1 秒所做的全部忽略与截断**（相对论/时空、矩阵与导数截断、观测者效应及站心 ENU 需补回项）见 [6-light-time-and-aberration.md](6-light-time-and-aberration.md) §「为满足国标 1 秒的忽略与截断总览」。
