...
本仓库文档分 11 章，每章一个文件。参考文献见 `doc/references/`；编算农历网页见 [ChineseCalendar](https://ytliu0.github.io/ChineseCalendar/computation_simp.html)。
...
| **9** | [9-solar-terms.md](9-solar-terms.md) | 二十四节气与定气、八步 pipeline、TDBtimes 格式 |
| **10** | [10-lunar-calendar.md](10-lunar-calendar.md) | 农历编算、流程与分层 |
| **11** | [11-project-and-implementation.md](11-project-and-implementation.md) | 项目结构、Rust 实现 |
